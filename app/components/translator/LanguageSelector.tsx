...
const LanguageSelector: React.FC = () => {
  ...
  const [leftLanguage, setLeftLanguage] = useState("Detect Language");
  const [rightLanguage, setRightLanguage] = useState("Arabic");
  ...
  const handleSwitch = () => {
    ...
    if (leftLanguage === "Detect Language") {
    ...
    const temp = leftLanguage;
    setLeftLanguage(rightLanguage);
    setRightLanguage(temp);
  };
  ...
  return (
    <div className="items-center flex px-4 py-4 gap-4">
      ...
      <div className="border rounded-full border-gray-300 px-4 py-4 flex items-center text-xl font-mono shadow-sm">
        <span className="text-gray-700 mr-4">{rightLanguage}</span>
